                        ...
                        <div class="row">
                            <table class="table table-bordered">
                              <thead>
                                <tr class="text-center">
                                  ...
                                  <th scope="col" width="20%">หมวดหมู่สินค้า</th>
                          ...
                          <tbody class="text-center">
                            ...
                            <?php foreach ($brand_list as $value) { ?>
                              ...
                              <td>
                                <a href="<?php echo site_url('admin/brand/edit'); ?>/<?php echo $value['id']; ?>">
                                  <input type="button" class="btn btn-warning" name="add" value="แก้ไข">
                                </a>
                                <a href="<?php echo site_url('admin/brand/delete'); ?>/<?php echo $value['id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล');">
