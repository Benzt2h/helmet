                    ...
                    <div class="card-body">
                      <div class="card">
                            <form class="form-horizontal" 
                              ...
                              method="post">
                            <!-- ชื่อตาราง -->
                            <input type="hidden" class="form-control" name="table" value="category">
                            <!-- End -->
                            <!-- ไอดี -->
                            <input type="hidden" class="form-control" name="id" value="<?php echo !empty($category_list[0]['id']) ? $category_list[0]['id'] : ''; ?>">
                            <!-- End -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                              ...
                                              class="form-control" 
                                              name="subject"
                                              value="<?php echo !empty($category_list[0]['subject']) ? $category_list[0]['subject'] : ''; ?>" 
