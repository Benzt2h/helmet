                    ...
                    <div class="card-body">
                      <div class="card">
                            <form class="form-horizontal" 
                              ...
                              method="post">
                            <!-- ชื่อตาราง -->
                            <input type="hidden" class="form-control" name="table" value="brand">
                            <!-- End -->
                            <!-- ไอดี -->
                            <input type="hidden" class="form-control" name="id" value="<?php echo !empty($brand_list[0]['id']) ? $brand_list[0]['id'] : ''; ?>">
                            <!-- End -->

                                <div class="card-body">
                                    <!-- Input Data -->
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">หมวดหมู่สินค้า</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" name="category_id">
                                                <?php foreach ($category as $key => $value) { ?>
                                                    <option value="<?php echo $value['id']; ?>" <?php echo !empty($brand_list[0]['category_id']) && $brand_list[0]['category_id'] == $value['id'] ? 'selected' : ''; ?>><?php echo $value['subject']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                              ...
                                              class="form-control" 
                                              name="subject"
                                              value="<?php echo !empty($brand_list[0]['subject']) ? $brand_list[0]['subject'] : ''; ?>" 
