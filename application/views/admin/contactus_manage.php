                    ...
                    <div class="card-body">
                      <div class="card">
                            <form class="form-horizontal" 
                              ...
                              method="post">
                            <!-- ชื่อตาราง -->
                            <input type="hidden" class="form-control" name="table" value="contactus">
                            <!-- End -->
                            <!-- ไอดี -->
                            <input type="hidden" class="form-control" name="id" value="<?php echo !empty($contactus_list[0]['id']) ? $contactus_list[0]['id'] : ''; ?>">
                            <!-- End -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input 
                                              ...
                                              class="form-control" 
                                              name="address"
                                              value="<?php echo !empty($contactus_list[0]['address']) ? $contactus_list[0]['address'] : ''; ?>" 
                                              placeholder="ที่อยู่">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">อีเมล์</label>
                                        <div class="col-sm-9">
                                            <input 
                                              type="text" 
                                              class="form-control" 
                                              name="email"
                                              value="<?php echo !empty($contactus_list[0]['email']) ? $contactus_list[0]['email'] : ''; ?>" 
                                              placeholder="อีเมล์">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">โทรหาเรา</label>
                                        <div class="col-sm-9">
                                            <input 
                                              type="text" 
                                              class="form-control" 
                                              name="call"
                                              value="<?php echo !empty($contactus_list[0]['call']) ? $contactus_list[0]['call'] : ''; ?>" 
                                              placeholder="โทรหาเรา">
                                        </div>
                                    </div>
                                    <!-- End Input Data -->
                                </div>
