                    ...
                    <div class="card-body">
                      <div class="card">
                            <form class="form-horizontal" 
                              ...
                              method="post">
                            <!-- ชื่อตาราง -->
                            <input type="hidden" class="form-control" name="table" value="services">
                            <!-- End -->
                            <!-- ไอดี -->
                            <input type="hidden" class="form-control" name="id" value="<?php echo !empty($services_list[0]['id']) ? $services_list[0]['id'] : ''; ?>">
                            <!-- End -->
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea name="detail" id="editor1">
                                                <?php echo !empty($services_list[0]['detail']) ? $services_list[0]['detail'] : ''; ?>
                                            </textarea>
                                        </div>
                                    </div>
                                    <!-- End Input Data -->
