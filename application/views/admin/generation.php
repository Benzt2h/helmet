                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-md-flex align-items-center">
                            <div>
                                <p>
                                    <a href="<?php echo site_url('admin/generation/add') ?>">
                        ...
                        <div class="row">
                            <table class="table">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col" width="15%">ยี่ห้อสินค้า</th>
                          ...
                          <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($generation_list as $value) { ?>
                              <tr>
                              <th scope="row"><?php echo $i; ?></th>
                              <td>
                                <?php foreach ($brand as $cat) {
                                  if ($value['brand_id'] == $cat['id']) { ?>
                                     <?php echo $cat['subject']; ?>
                                  <?php }
                                } ?>
                              </td>
                              <td><?php echo $value['subject']; ?></td>
                              <td>
                                <a href="<?php echo site_url('admin/generation/edit'); ?>/<?php echo $value['id']; ?>">
                                  <input type="button" class="btn btn-warning" name="add" value="แก้ไข">
                                </a>
                                <a href="<?php echo site_url('admin/generation/delete'); ?>/<?php echo $value['id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล');">
