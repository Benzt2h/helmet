...
<!-- login -->
		<div class="w3_login">
			<h3>ลงชื่อเข้าใช้และลงทะเบียน</h3>
			<div class="w3_login_module">
				<div class="module form-module">
				  ...
				  <div class="form">
					...
					<form action="<?php echo site_url('helmet/process_login')?>" method="post">
				  ...
				  <div class="form">
					<h2>สมัครสมาชิก</h2>
					<form action="<?php echo site_url('helmet/register_user')?>" method="post">
					  <input type="text" name="username" placeholder="Username" required=" ">
					  <input type="password" name="password" placeholder="Password" required=" ">
				  ...
				  <div class="cta"><a href="#">ลืมรหัสผ่านหรือไม่?</a></div>
				</div>
			</div>
			<script>
